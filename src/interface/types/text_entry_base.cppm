...
export {
	...
	namespace wgui {
		class WIText;
		class DLLWGUI WITextEntryBase : public wgui::WIBase {
		public:
		...
		protected:
			...
			wgui::WIHandle m_hCaret;
			wgui::WIHandle m_hEntryFieldElement;
			int m_maxLength;
			int m_posCaret;
	...
	namespace umath::scoped_enum::bitwise {
		template<>
		struct enable_bitwise_operators<wgui::WITextEntryBase::StateFlags> : std::true_type {};
	}
};
