...
export {
	class DLLWGUI WITextBase : public wgui::WIBase {
	public:
	...
	namespace wgui {
		...
		private:
			...
			// Shadow
			wgui::WIHandle m_baseTextShadow;
	...
	namespace umath::scoped_enum::bitwise {
		template<>
		struct enable_bitwise_operators<wgui::WIText::Flags> : std::true_type {};
	}

	template<class TDecorator, typename... TARGS>
	std::shared_ptr<WITextDecorator> wgui::WIText::AddDecorator(TARGS &&...args)
	{
