...
export {
	...
	namespace wgui {
		...
		private:
			...
			std::unique_ptr<wgui::TypeFactory> m_typeFactory;
	...
	namespace umath::scoped_enum::bitwise {
		template<>
		struct enable_bitwise_operators<wgui::WGUI::ElementBuffer> : std::true_type {};
	}

	template<class TSkin>
	TSkin *wgui::WGUI::RegisterSkin(std::string id, bool bReload)
	{
		ustring::to_lower(id);
	...
	template<class TElement>
	void wgui::WGUI::Setup(WIBase &el, WIBase *parent)
	{
	...
	template<class TElement>
	TElement *wgui::WGUI::Create(WIBase *parent)
	{
